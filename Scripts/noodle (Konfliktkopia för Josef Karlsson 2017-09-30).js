    ...
    node: {
        ...
        setSockEv(node){
            $('.socket').unbind().mousedown(function(e){ //TODO: Only set this event for children of node.html
                ...
                var port = nodeNoodle.port.getObj(nodeNoodle, active.socketEl.parentElement);
                ...
                $('.socket').mouseup(function(e){
                    var pullPort = noodle.port.getObj(noodle, active.socketEl.parentElement);
    ...
    graphics: {
        ...
        transformable: {
            ...
            close(){
                ...
                //disconnectNode(noodle.node.getObj(noodle, nodeEl));
